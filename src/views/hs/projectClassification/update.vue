  ...
  <div class="app-container">
    ...
    <el-card class="form-container" shadow="never">
      <el-form :model="add" ref="addFrom" label-width="150px" >
        ...
        <el-form-item label="图标" prop="subjectImage">
          <single-upload v-model="add.subjectImage"></single-upload>
        </el-form-item>
        <el-form-item label="背景颜色值（RGB）" prop="logo">
         <el-color-picker   v-model="add.color"></el-color-picker>
        </el-form-item>
...
<script>
import { createhs,updatehs,geths } from "@/api/hs";
...
export default {
  ...
  created() {
    ...
    if (this.isEdit) {
      geths(this.$route.query.id).then(response => {
        this.add = response;
      });
    } else {
