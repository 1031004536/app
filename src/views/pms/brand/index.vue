    ...
    <div class="table-container">
      <el-table ref="brandTable"
        ...
        <el-table-column label="品牌logo" align="center">
          <template slot-scope="scope"><img :src="scope.row.logo" alt="" style="width:80px;height:80px"></template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        this.$router.push({path: '/pms/brand/update', query: {brandId: row.brandId}})
      },
      ...
      handleFactoryStatusChange(index, row) {
        ...
        data.append("brandIds", row.brandId);
      ...
      handleBatchOperate() {
        ...
        for (let i = 0; i < this.multipleSelection.length; i++) {
          brandIds.push(this.multipleSelection[i].id);
        }
        let data = new URLSearchParams();
        data.append("brandIds", brandIds);
      ...
      addBrand() {
        this.$router.push({path: '/pms/brand/add'})
      }
    }
  }
</script>
