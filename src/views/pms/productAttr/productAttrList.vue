    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="编号" width="100" align="center">
          <template slot-scope="scope">{{scope.row.productAttributeId}}</template>
        </el-table-column>
        <el-table-column label="属性名称" width="140" align="center">
          <template slot-scope="scope">{{scope.row.productAttributeName}}</template>
        </el-table-column>
  ...
  export default {
    ...
    data() {
      return {
        ...
        listQuery: {
          ...
          productAttributeCategoryId:this.$route.query.cid
        },
        operateType: null,
        multipleSelection: [],
        operates: [
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        this.$router.push({path:'/pms/productAttr/updateProductAttr',query:{id:row.productAttributeId}});
      },
      ...
      handleDelete(index, row) {
        let ids = [];
        ids.push(row.productAttributeId);
        this.handleDeleteProductAttr(ids);
      },
    },
    filters: {
